...
% Only for non-conditional simulation. Deposition.
% Inputs:
...
function write_dimension_parfile_depo(filename,gx,gy)
fid =  fopen(filename,'w');
fprintf(fid,'                  Parameters for SGSIM\r\n');
fprintf(fid,'                  ********************\r\n');
fprintf(fid,'                                        \r\n');
fprintf(fid,'START OF PARAMETERS:\r\n');
fprintf(fid,'hard_data_deposition.txt                            -file with data\r\n');
...
fprintf(fid,'sgs_deposition.txt                     -file for simulation output\r\n');

% Writes .par file for sgsim to add noise to the simulation. Only for non-
% conditional simulation. Fine-grained unit.
% Inputs:
...
function write_dimension_parfile_fgu(filename,gx,gy)
